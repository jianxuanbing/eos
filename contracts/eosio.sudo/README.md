...
```
$ cleos system newaccount -s -j -d --transfer --stake-net "1.000 SBC" --stake-cpu "1.000 SBC" --buy-ram-kbytes 50 eosio eosio.sudo EOS8MMUW11TAdTDxqdSwSqJodefSoZbFhcprndomgLi9MeR2o8MT4 > generated_account_creation_trx.json
...
net bandwidth:
     staked:          1.0000 SBC           (total stake delegated from account to self)
     delegated:       0.0000 SBC           (total staked delegated to account from others)
     used:                 0 bytes
     available:        2.304 MiB  
     limit:            2.304 MiB  
